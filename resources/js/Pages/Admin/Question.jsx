                                ...
                                <tbody>
                                    {questions.data.map((question, index) => (
                                        <tr className="" key={index}>
                                            ...
                                            <td className="tw-p-2">{question.questiondetail.QuestionTitle}</td>
                                            <td className="tw-p-2">{question.questiondetail.QuestionDetail}</td>
                                                    ...
                                                    <div className="modal-dialog">
                                                        <div className="modal-content">
                                                            <div className="modal-header">
                                                                <h1 className="modal-title fs-5" id={`staticBackdropLabel${question.QuestionID}`}>
                                                                    Hapus Pertanyaan
                                                                </h1>
                                                                <button
                                                                    type="button"
                                                            ...
                                                            <div className="modal-body">
                                                                <form action={`/admin/pertanyaan/delete/${question.QuestionID}`} method="POST">
