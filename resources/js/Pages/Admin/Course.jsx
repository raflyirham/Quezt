        ...
        <div className="d-flex flex-row justify-content-between align-items-start tw-mt-14">
          ...
          <div className="tw-py-4 tw-px-8 tw-min-h-screen w-full flex-fill">
            <div className="d-flex flex-column gap-5 justify-content-start align-items-start">
                  ...
                  {course.map((item) => (
                    <tr className="">
                      ...
                      <td className="tw-p-2 tw-px-4 tw-text-center">
                        <button className="tw-px-6 tw-py-2 tw-rounded-full">
                          Delete
                        </button>
                      </td>
                    </tr>
              ...
              <button
                type="button"
                className="tw-px-10 tw-py-3 tw-rounded-full tw-flex tw-justify-items-center tw-gap-2"
                      ...
                      <form action="/submit" method="POST">
                        ...
                        <div className="mb-3">
                          ...
                          <div id="descHelp" className="form-text">
                            Input short description about the course.
                          </div>
                        </div>
                      </form>
                    </div>
