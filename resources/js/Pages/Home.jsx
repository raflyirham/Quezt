...
export default function Home({ majors }) {
    ...
    return (
        <>
            ...
            {((usePage().props['user_data'] == null) || (usePage().props['user_data'].RoleID != 2)) && (
                <div className="tw-p-4 tw-mb-2 tw-mt-4">
                    <div className="tw-shadow-lg tw-p-4">
                        <h2 className="tw-font-monda tw-font-bold tw-text-3xl tw-text-[#C70039]">Tanyakan Materi Perkuliahan Kamu</h2>
                        ...
                        >
                            ...
                            <div className="tw-flex tw-flex-col">
                                ...
                                <select name="jurusan" id="jurusan" className="tw-p-2 tw-border-[1px] tw-border-[#d6d6d6] tw-rounded tw-mt-2" required defaultValue="Pilih Jurusan" onChange={handleMajorSelect}>
                                    <option value="Pilih Jurusan" disabled hidden>Pilih Jurusan</option>
                            ...
                            <div className="tw-flex tw-flex-col">
                                ...
                                <select ref={courseRef} name="mata_kuliah" id="mata_kuliah" className="tw-p-2 tw-border-[1px] tw-border-[#d6d6d6] tw-rounded tw-mt-2" required defaultValue="DEFAULT" >
                                    <option value="DEFAULT" disabled hidden>Pilih Mata Kuliah</option>
            ...
            <div className="tw-p-4 tw-mb-16 tw-z-[-999px]">
                <div className="tw-flex tw-flex-col tw-justify-center tw-items-center tw-px-4 tw-py-14 tw-rounded tw-bg-gradient-to-b tw-from-[#C70039] tw-to-[#B23358] tw-min-h-[500px]">
                    <div className="tw-flex tw-flex-col tw-justify-center tw-items-center tw-w-[35%] tw-text-center max-lg:tw-w-[80%]">
                        ...
                        <p className="tw-font-monda tw-font-normal tw-text-xl tw-text-[#fff] tw-mb-4 max-md:tw-text-lg">Jangan khawatir! Tutor siap membantu kamu.</p>
                ...
                <div className="tw-absolute tw-mt-[-430px] max-lg:tw-hidden max-xl:tw-w-[350px] max-xl:tw-mt-[-350px]">
                    <img src="assets/img/home/illustration-2.png" className="tw-w-[450px]" />
                </div>
