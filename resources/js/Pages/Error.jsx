  ...
  return (
    <>
      ...
      <div className="tw-flex tw-flex-col tw-justify-center tw-items-center tw-p-4 tw-min-h-screen">
        ...
        <Link href="/">
          <button className="tw-rounded tw-px-4 tw-py-2 tw-bg-[#C70039] tw-text-white tw-font-monda tw-font-bold tw-mt-4 tw-text-sm tw-hover:bg-[#d50a43] tw-active:bg-[#bb073a] tw-duration-200">
            {"< Kembali ke Beranda"}
          </button>
        </Link>
      </div>
