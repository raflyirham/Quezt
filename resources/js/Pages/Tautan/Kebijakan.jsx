                    ...
                    <div className="flex flex-col gap-y-6 w-[100%] shadow-lg px-8 py-8">
                        <div>
                            ...
                            <p className="font-monda text-lg mt-2">
                                ...
                                dikumpulkan dan dicatat oleh Quezt dan bagaimana
                                kami menggunakannya. Jika Anda memiliki
                                pertanyaan tambahan atau memerlukan informasi
                                lebih lanjut tentang Kebijakan Privasi kami,
                        ...
                        <div>
                            ...
                            <p className="font-monda text-lg mt-2">
                                ...
                                Semua perusahaan hosting melakukan ini dan
                                merupakan bagian dari analisis layanan hosting.
                                Informasi yang dikumpulkan oleh file log
                                termasuk alamat protokol internet (IP), jenis
                                browser, Penyedia Layanan Internet (ISP),
                                stempel tanggal dan waktu, halaman yang dirujuk
                                / keluar, dan mungkin jumlah klik. Semua ini
                                tidak terkait dengan informasi apa pun yang
                                dapat diidentifikasi secara pribadi. Tujuan dari
                                informasi ini adalah untuk menganalisis tren,
                                mengelola situs, melacak pergerakan pengguna di
                                situs web, dan mengumpulkan informasi
                                demografis. Kebijakan Privasi kami dibuat dengan
                                bantuan Generator Kebijakan Privasi.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="font-monda text-lg mt-2">
                                ...
                                halaman di situs web yang diakses atau
                                dikunjungi pengunjung. Informasi ini digunakan
                                untuk mengoptimalkan pengalaman pengguna dengan
                                menyesuaikan konten halaman web kami berdasarkan
                            ...
                            <p className="font-monda text-lg mt-2">
                                ...
                                masing-masing iklan dan tautan yang muncul di
                                Quezt, yang dikirim langsung ke browser
                                pengguna. Mereka secara otomatis menerima alamat
                                IP Anda ketika hal ini terjadi. Teknologi ini
                                digunakan untuk mengukur efektivitas kampanye
                                iklan mereka dan / atau untuk mempersonalisasi
                                konten iklan yang Anda lihat di situs web yang
                                Anda kunjungi.
                            </p>
                        ...
                        <div>
                            ...
                            <p className="font-monda text-lg mt-2">
                                ...
                                masing-masing Kebijakan Privasi dari server
                                iklan pihak ketiga ini untuk informasi yang
                                lebih terperinci. Ini mungkin termasuk praktik
                                dan instruksi mereka tentang cara menyisih dari
                                opsi tertentu.
                            </p>
                            ...
                            <p className="font-monda text-lg mt-2">
                                ...
                                manajemen cookie dengan browser web tertentu,
                                dapat ditemukan di situs web masing-masing
                        ...
                        <div>
                            ...
                            <p className="font-monda text-lg mt-2">
                                ...
                                dan wali untuk mengamati, berpartisipasi dalam,
                                dan / atau memantau dan membimbing aktivitas
                                online mereka.
                            </p>
                            ...
                            <p className="font-monda text-lg mt-2">
                                ...
                                merasa bahwa anak Anda memberikan informasi
                                semacam ini di situs web kami, kami sangat
                                menganjurkan Anda untuk segera menghubungi kami
                                dan kami akan melakukan upaya terbaik kami untuk
                                segera menghapus informasi tersebut dari catatan
                                kami.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="font-monda text-lg mt-2">
                                ...
                                informasi yang mereka bagikan dan / atau
                                kumpulkan di Quezt. Kebijakan ini tidak berlaku
                                untuk informasi apa pun yang dikumpulkan secara
                                offline atau melalui saluran selain situs web
                                ini.
                            </p>
                        </div>
