        ...
        <div className="tw-grid tw-grid-cols-5 tw-gap-8 tw-px-4 tw-py-10 tw-border-t-[2px] tw-border-t-[#C70039] max-lg:tw-grid-cols-1">
            <div>
                ...
                <p className="tw-font-monda tw-font-normal tw-text-sm tw-text-black tw-mt-4">
                    ...
                    perkuliahan. Jawaban yang diberikan pada website ini merupakan tutor
                    yang memiliki kompetensi sesuai dengan aturan dan standar website ini.
                </p>
            </div>
            ...
            <div>
                ...
                <div className="tw-flex tw-flex-col tw-gap-y-[0.5px]">
                    <Link href="/jurusan/teknik-informatika" className="tw-w-fit tw-mt-4">
                        <p className="tw-font-monda tw-font-normal tw-text-sm tw-text-black hover:tw-text-[#C70039] tw-duration-200">
                            Teknik Informatika
                        </p>
                    </Link>

                    <Link href="/jurusan/ilmu-komunikasi" className="tw-w-fit tw-mt-4">
                        <p className="tw-font-monda tw-font-normal tw-text-sm tw-text-black hover:tw-text-[#C70039] tw-duration-200">
                            Ilmu Komunikasi
                        </p>
                    </Link>
            ...
            <div>
                ...
                <div className="tw-flex tw-flex-col tw-gap-y-[0.5px]">
                    ...
                    <Link href="/produk" className="tw-w-fit tw-mt-4">
                        <p className="tw-font-monda tw-font-normal tw-text-sm tw-text-black hover:tw-text-[#C70039] tw-duration-200">
                            Informasi Produk
                        </p>
                    </Link>
