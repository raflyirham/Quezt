        ...
        <div className="tw-flex tw-flex-col tw-mt-2 tw-gap-y-1">
          <Link href="/dashboard/detail">
            {usePage().url === "/dashboard/detail" ? (
              ...
              <p className="tw-font-monda tw-text-base tw-p-2 tw-hover:bg-[#C70039] tw-hover:text-white tw-hover:rounded tw-duration-300 tw-w-full tw-border-b-[1px] tw-border-[#C70039]">
                Detail Akun
              </p>
            )}
          </Link>
