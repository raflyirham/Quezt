...
export default function ProfileContentCard({ link, title, detail, courseName, majorName, date, description }) {
    return (
        <Link className="tw-mt-3 tw-shadow-lg tw-py-6 tw-px-8 tw-break-all" href={link}>
            <h3 className="tw-font-monda tw-font-bold tw-text-[#C70039] tw-text-lg">{title}</h3>
