            ...
            <tbody className="tw-divide-y-2 tw-divide-black">
              {course.map((item) => (
                <tr
                  ...
                  key={item.CourseID}>
                  <td className="tw-p-2 tw-text-center">{item.CourseID}</td>
                  <td className="tw-p-2 ">{item.CourseName}</td>
                  <td className="tw-p-2">
                    {
                      major.find((target) => item.MajorID === target.MajorID)
                        .MajorName
                    }
                  </td>
                  <td className="tw-p-2 ">{item.CourseDescription}</td>
