        ...
        <>
            ...
            <nav
                ...
                <ul className="">
                    ...
                    <li className="tw-py-4 tw-px-8 lg:tw-pr-14 lg:tw-pl-4 nav-item">
                        <Link className="p-0 tw-text-left nav-link" href="/admin/jurusan">
                            Jurusan
                        </Link>
                    </li>
                    <li className="tw-py-4 tw-px-8 lg:tw-pr-14 lg:tw-pl-4 nav-item">
                        <Link className="p-0 tw-text-left nav-link" href="/admin/mata-kuliah">
                            Mata Kuliah
                        </Link>
                    </li>
                    <li className="tw-py-4 tw-px-8 lg:tw-pr-14 lg:tw-pl-4 nav-item">
                    ...
                    <li className="tw-py-4 tw-px-8 lg:tw-pr-14 lg:tw-pl-4 nav-item">
                        <Link className="p-0 tw-text-left nav-link" href="/admin/pertanyaan">
                            Pertanyaan
                        </Link>
                    </li>
                    <li className="tw-py-4 tw-px-8 lg:tw-pr-14 lg:tw-pl-4 nav-item">
