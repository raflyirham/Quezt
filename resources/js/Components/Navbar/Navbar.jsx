        ...
        <>
            <div className="shadow-lg flex flex-row p-4 justify-between fixed top-0 z-50 bg-white w-full">
                <div className="flex flex-row gap-x-2 items-baseline">
                    ...
                    <div className="flex flex-row gap-x-6 justify-center items-center ml-4 max-lg:hidden">
                        <Link href="/">
            ...
            <div className="hidden fixed bottom-4 left-1/2 translate-x-[-50%] min-w-[80%] max-lg:block">
                <div className="flex flex-row justify-evenly items-center px-6 py-3 bg-white shadow-2xl border-[1px] border-[#C70039] rounded-full">
                    <Link
                        href="/"
                        className="text-center font-monda font-bold text-sm text-[#C70039] hover:text-[#d50a43] hover:underline active:text-[#bb073a] duration-500"
                    >
                    ...
                    >
                        ...
                        <p className="mt-1">Mata Kuliah</p>
                    </Link>
                </div>
            </div>
        </>
